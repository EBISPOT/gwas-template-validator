...
import uk.ac.ebi.spot.gwas.template.validator.config.AssociationValidationConfig;
...
public class AssociationValidator implements TemplateValidator {

    @Autowired
    private AssociationValidationConfig associationValidationConfig;
    ...
    public void validateSheet(Sheet sheet, Map<String, String> studyTags) {
        ...
        while (rowIterator.hasNext()) {
            ...
            if (count >= associationValidationConfig.getStartingRow()) {
                RowValidator rowValidator = new RowValidator(currentRow, associationValidationConfig.getColumns());
